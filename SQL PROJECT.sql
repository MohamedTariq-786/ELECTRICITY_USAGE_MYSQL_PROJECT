...
use project;
select count(*) from appliance_usage;
...
alter table appliance_usage add foreign key(household_id) references household_info(household_id);

alter table billing_info modify household_id varchar(10) not null;
alter table billing_info add primary key (household_id);
alter table billing_info add foreign key(household_id) references household_info(household_id);
...
alter table calculated_metrics add foreign key(household_id) references household_info(household_id);
...
alter table environmental_data add foreign key(household_id) references household_info(household_id);
